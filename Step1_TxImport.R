...
library(datapasta) #great for copy/paste into the R environment
...
help(getSequence)
  ...
  mart <- useEnsembl("ensembl", dataset="mpfuro_gene_ensembl")
  
  seq = getSequence(id = c("IFIT2", "OAS2", "IRF1", "IFNAR1", "MX1"),

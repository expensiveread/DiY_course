...
install(usethis)
usethis::use_git_config(user.name = "NicholasParenti", user.email = "NicholasAParenti@gmail.com")
usethis::create_github_token()
credentials::set_github_pat("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")
